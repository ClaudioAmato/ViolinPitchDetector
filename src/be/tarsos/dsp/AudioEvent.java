...
public class AudioEvent {
	...
	/**
	 * Calculates and returns the time stamp at the beginning of this audio
	 * event.
	 * 
	...
	/**
	 * Return a byte array with the audio data in bytes. A conversion is done
	 * from float, cache accordingly on the other side...
	 * 
	...
	/**
	 * Calculates and returns the root mean square of the signal. Please cache
	 * the result since it is calculated every time.
	 * 
	 * @return The

...
/**
 * Downloads a static ffmpeg binary for several platforms: Windows x64 and x32
 * Max OS X x64 Linux x32 and x64 The code tries to determine the correct
 * platform and downloads it to the temporary directory
 * <code>System.getProperty("java.io.tmpdir")</code>.
 * 
 * After downloading it makes the binary executable. The location of the
 * downloaded binary is returned by <code>ffmpegBinary();</code>
 * 
 * @author Joren Six
 */

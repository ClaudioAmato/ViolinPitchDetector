...
public final class PitchConverter {
	...
	public static double midiKeyToHertz(final int midiKey) {
		if (midiKey < 0 || midiKey > 127) {
			throw new IllegalArgumentException(
					"MIDI keys are values from 0 to 127, inclusive " + midiKey + " is invalid.");
		}
	 ...
	 *         IllegalArgumentException ("Relative cent values are values from 0
	 *         to 1199, inclusive " + relativeCent + " is invalid."); int
	 *         defaultOctave = 5; int offset = defaultOctave * 1200; return
	 *         absoluteCentToHertz(relativeCent + offset); }
	 */
	 ...
	 * ratios to cents and back again" in the book "Tuning Timbre Spectrum
	 * Scale" William A. Sethares.
	 * 
	 * @param cent
	 *            A cent value
	 ...
	 * cents and back again" in the book "Tuning Timbre Spectrum Scale" William
	 * A. Sethares
	 * 
	 * @param ratio
	 *            A cent value

...
public class Oscilloscope implements AudioProcessor {
	public static interface OscilloscopeEventHandler {
		/**
		 * @param data
		 *            The data contains a float array with: array[i] an x
		 *            coordinate in percentage array[i+1] the value of the
		 *            amplitude in audio buffer array[i+2] another x coordinate
		 *            in percentage array[i+3] the next amplitude in the audio
		 *            buffer
		 * @param event
		 *            An audio Event.
		 */

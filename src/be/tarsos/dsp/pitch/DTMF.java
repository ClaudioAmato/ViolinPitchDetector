...
public class DTMF {
	 ...
	 * and frequencies.
	 */
	public static final char[][] DTMF_CHARACTERS = { { '1', '2', '3', 'A' }, { '4', '5', '6', 'B' },
			{ '7', '8', '9', 'C' }, { '*', '0', '#', 'D' } };
	 ...
	 * @return a float buffer of predefined length (7168 samples) with the
	 *         correct DTMF tone representing the character.
	 */

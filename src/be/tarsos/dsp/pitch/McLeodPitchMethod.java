 ...
 * to <code>O((W+w)log(W+w))</code> by using an
 * <abbr title="Fast Fourier Transform">FFT</abbr> to calculate the
 * <abbr title="Auto-Correlation Function">ACF</abbr>. But I am still afraid of
 * the dark magic of the FFT and clinging to the familiar, friendly, laggard
 * time domain.
 * </p>
 * 
...
public final class McLeodPitchMethod implements PitchDetector {
	 ...
	 * <code>b - a = 1</code> the formula for
	 * <a href="http://fizyka.umk.pl/nrbook/c10-2.pdf">parabolic
	 * interpolation</a> can be simplified a lot.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Implementation based on the GPL'ED code of
	 * <a href="http://tartini.net">Tartini</a> This code can be found in the
	 * file <code>general/mytransforms.cpp</code>.
	 * </p>
	 * <p>

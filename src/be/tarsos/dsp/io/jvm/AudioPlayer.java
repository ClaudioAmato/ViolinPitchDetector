 ...
 * sound. The write method on LineWavelet is interesting because it blocks until
 * it is ready for more data. </i></blockquote> If this AudioProcessor chained
 * with other AudioProcessors the others should be able to operate in real time
 * or process the signal on a separate thread.
 * 
 * @author Joren Six
 */
public final class AudioPlayer implements AudioProcessor {
	...
	/**
	 * The LineWavelet to send sound to. Is also used to keep everything in
	 * sync.
	 */
	...
	public boolean process(AudioEvent audioEvent) {
		 ...
		 * line.getMicrosecondPosition()); }else {

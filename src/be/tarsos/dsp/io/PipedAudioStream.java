...
public class PipedAudioStream {
	...
	// Logger.getLogger(PipedAudioStream.class.getName());
	...
	/**
	 * Return a one channel, signed PCM stream of audio of a defined sample
	 * rate.
	 * 
	 ...
	 *            the number of seconds to pipe. If negative the stream is
	 *            processed until end of stream.
	 * @return An audio stream which can be used to read samples from.
	 */
	public TarsosDSPAudioInputStream getMonoStream(int targetSampleRate, double startTimeOffset,
